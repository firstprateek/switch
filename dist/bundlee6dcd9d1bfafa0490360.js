...
var SimpleToggle = /*#__PURE__*/function (_LitElement) {
  _inherits(SimpleToggle, _LitElement);
  var _super = _createSuper(SimpleToggle);
  function SimpleToggle() {
    var _this;
    _classCallCheck(this, SimpleToggle);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleChange", function (e) {
      ...
      _this.dispatchEvent(new CustomEvent('change', options));
    });
    return _this;
  }
  _createClass(SimpleToggle, [{
    key: "render",
    value: function render() {
      return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n            <input @change=", " type=\"checkbox\" class=\"checkbox\" id=\"checkbox\">\n            <label for=\"checkbox\" class=\"label\">\n                <div class=\"ball\"></div>\n            </label>\n        "])), this.handleChange);
    }
  }]);
  return SimpleToggle;
}(lit__WEBPACK_IMPORTED_MODULE_0__.LitElement);
_defineProperty(SimpleToggle, "styles", (0,lit__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n        * {\n            box-sizing: border-box;\n        }\n\n        .checkbox {\n            opacity: 0;\n            position: absolute;\n        }\n\n        .checkbox:checked + .label .ball {\n            transform: translateX(24px);\n        }\n\n        .label {\n            background-color: var(--background-color, #F2F0EE);\n            height: 26px;\n            width: 50px;\n            display: flex;\n            align-items: center;\n            justify-content: space-between;\n            border-radius: 50px;\n            position: relative;\n            cursor: pointer;\n        }\n\n        .left-icon {\n            color: #f1c40f;\n        }\n\n        .right-icon {\n            color: #f39c12;\n        }\n\n        .ball {\n            background-color: var(--link-color, #58595B);\n            height: 26px;\n            width: 26px;\n            position: absolute;\n            border-radius: 50%;\n            transition: transform 0.2s linear;\n        }\n\n    "]))));
_defineProperty(SimpleToggle, "properties", {
  leftIcon: {},
  rightIcon: {}
});
...
/******/ })()
;
//# sourceMappingURL=bundlee6dcd9d1bfafa0490360.js.map